      ...
      />
            <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <form className="flex flex-col space-y-4">
                    ...
                    <button type="button" disabled={isLoading ? true : false} onClick={handleLogin} className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors duration-300 disabled:bg-slate-400">Login</button>
            {isLoading && <Loader/>}
                </form>
            </div>
        </div>
