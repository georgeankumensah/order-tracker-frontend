...
const ProductDetail = () => {
  ...
  const formattedOrderDate = createdAt
    ...
    : "UNKNOWN";
  const formattedArrivalDate = expectedArrivalTime
    ? new Date(expectedArrivalTime).toLocaleDateString("en-US", {
        day: "numeric",
        month: "long",
        year: "numeric",
      })
      ...
      <div className="flex justify-between">
        <div>
          ...
          <div className="flex items-center gap-[1rem]">
            <p className="font-medium text-[#0a0a0a] mr-2">
              Order date : {formattedOrderDate}
            </p>
            <p className=" font-medium  text-green-500">
              Estimated delivery : {formattedArrivalDate || " UNKNOWN"}{" "}
            </p>
          </div>
        </div>
