  ...
  const Loader = () =>{
    return(
      <div className="flex items-center  ">
        ...
        Wait while we find your package..
        </p>
      </div>
    )
  }
    ...
    <div className=" bg-[#f7f7f7]">
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col pl-[2rem] gap-[1rem] relative">
          <h1 className="text-[#003C75] text-[4.40356rem] not-italic font-extrabold leading-[normal]">
          ...
          <div className="flex items-center border-[1px] w-fit shadow-lg">
            ...
            <button
              ...
              className="bg-green-600 h-[3rem] w-[8rem] text-xl font-bold text-white px-[15px]"
            >
              Track
            </button>
          </div>
        ...
        <img
          src={deliveryGuy}
          className="aspect-auto h-[34.625rem] bg-yellow-200"
          alt="delivery guy"
        />
      </div>
    </div>
